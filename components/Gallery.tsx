...
const DEFAULT_PROJECTS: GalleryItem[] = [
  ...
  proj("p38", "BRANDING",  "Namibian enlistment war time concept Poster", "Namibia", "A graphic poster for the Namibian enlistment war time concept.", ["/Images/Namibian Propaganda poster-3.webp"], { visualWeight: "heavy", dominantColor: "brown" }),
